...
#import "ShopsListViewController.h"
...
@interface ShopsListViewController ()

@end

@implementation ShopsListViewController
...
- (void)viewDidLoad
{
    ...
    self.screenName = @"Shops List Screen";
    ...
    NSString * requestURL = [NSString stringWithFormat:@"https://handy-il.com/Handy/returnShops.php"];
