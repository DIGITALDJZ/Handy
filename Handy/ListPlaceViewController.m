...
- (void)viewDidLoad
{
    ...
    self.screenName = @"Place Screen From List";
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor whiteColor]}];
    ListViewController * myListView = [[ListViewController alloc]init];
    
    currentPlace = [myListView currentPlaceForCellDict];
    nameLabel.text = currentPlace[@"PinName"];
    typeLabel.text = currentPlace[@"Address"];
    decLabel.text = currentPlace[@"Phone"];
    descLabel.text = currentPlace[@"Description"];
    photoString = currentPlace[@"ImageDirectory"];
    placeImage.image = [self returnListPatientImage];
    NSLog(@"CurrentPlaceInView: %@", currentPlace);
    
    UIFont * roboto = [UIFont fontWithName:@"Roboto-Light" size:15.0];
    UIFont * robotoReg = [UIFont fontWithName:@"Roboto-Regular" size:30.0];
...
-(UIImage*)returnListPatientImage {
    ...
    ListViewController *dict = [[ListViewController alloc]init];
