...
#import "ParkingSpotsViewController.h"
...
@interface ParkingSpotsViewController ()

@end

@implementation ParkingSpotsViewController
...
- (void)viewDidLoad
{
    ...
    self.screenName = @"Parking Spots List Screen";
    ...
    NSString * requestURL = [NSString stringWithFormat:@"https://handy-il.com/Handy/returnParkingSpots.php"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIFont * latoBold20 = [UIFont fontWithName:@"Lato-Bold" size:23.0];
